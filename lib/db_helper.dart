...
class DatabaseHelper {
  ...
  static const colPersonName = 'personName';
  //DocumentList
  static const colDocName = 'docName';
  static const colOriginal = 'original';
  static const colScan = 'scan';
  ...
  readDataById(table, itemId) async {
    return await _db.query(table, where: "id=?", whereArgs: [itemId]);
  }

  Future<int> update(Map<String, dynamic> row, String tableName) async {
    int id = row[colId];
    return await _db.update(tableName, row, where: '$colId=?', whereArgs: [id]);
  }
}
